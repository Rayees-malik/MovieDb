                ...
                return <MDBRow style={{ display: "inline-block" }}>
                    <MDBCol>
                        <MDBCard style={{ width: "28rem" }}>
                            ...
                            <MDBCardBody cascade>
                                <MDBCardTitle><Link to={{ pathname: "/moviedetails/"+searchResults.id, state: { movie_id: searchResults.id } }}>{searchResults.title}</Link> <br /> <img width="30px" height="30px" src={Star} />&nbsp;&nbsp; {searchResults.vote_average}</MDBCardTitle>
